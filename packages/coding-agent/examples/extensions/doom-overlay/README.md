...
Play DOOM as an overlay in lunR. Demonstrates that the overlay system can handle real-time game rendering at 35 FPS.

## Usage

```bash
lunr --extension ./examples/extensions/doom-overlay
```
