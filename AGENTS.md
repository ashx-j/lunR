...
Last updated: 2026-08-20. **`origin/master` = `7f03ebc`**. Public npm is `@ashx-j/lunr@0.2.6` (tag `v0.2.6`). **NEVER MERGE `archive/extension-absorption-DO-NOT-MERGE`.** Untracked locals: `prompts/`, `DESIGN.md`, `LUNR_SYSTEM_INJECTION.md`, `lunR-checklist.md`, `.pi-subagents/`.
