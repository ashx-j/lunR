...
Last updated: 2026-08-29 (v0.2.12 shipped). **`origin/master` = `536d0f3`** (tag `v0.2.12` = `788e680`). Public npm is `@ashx-j/lunr@0.2.12`. **NEVER MERGE `archive/extension-absorption-DO-NOT-MERGE`.** Untracked locals: `prompts/`, `DESIGN.md`, `LUNR_SYSTEM_INJECTION.md`, `lunR-checklist.md`, `.pi-subagents/`.
