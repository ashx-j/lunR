...
Last updated: 2026-08-20. **`origin/master` pending push of v0.2.7**. Public npm is `@ashx-j/lunr@0.2.7` (tag `v0.2.7`). **NEVER MERGE `archive/extension-absorption-DO-NOT-MERGE`.** Untracked locals: `prompts/`, `DESIGN.md`, `LUNR_SYSTEM_INJECTION.md`, `lunR-checklist.md`, `.pi-subagents/`.
...
- **Install:** `npm i -g @ashx-j/lunr` (Node ≥ 22.19). Current published: **0.2.7**.
...
- `npx lunr --version` / published CLI → **0.2.7**. **Rebuild coding-agent `dist` after merge** or features look missing.
