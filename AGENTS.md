...
Last updated: 2026-08-20. **`origin/master` pending push of v0.2.5**. Public npm is `@ashx-j/lunr@0.2.5` (tag `v0.2.5`). **NEVER MERGE `archive/extension-absorption-DO-NOT-MERGE`.** Untracked locals: `prompts/`, `DESIGN.md`, `LUNR_SYSTEM_INJECTION.md`, `lunR-checklist.md`, `.pi-subagents/`.
