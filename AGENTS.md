...
Last updated: 2026-08-16. **`origin/master` = `c922e9a`**. Public npm is `@ashx-j/lunr@0.1.2` (tag `v0.1.2`). **NEVER MERGE `archive/extension-absorption-DO-NOT-MERGE`.** Untracked locals: `prompts/`, `DESIGN.md`, `LUNR_SYSTEM_INJECTION.md`, `lunR-checklist.md`, `.pi-subagents/`.

## On origin/master (`c922e9a`)
